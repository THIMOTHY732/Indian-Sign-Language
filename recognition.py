...
def text_detection():
    ...
    if text_input:
        ...
        if a in isl_gif:
            gif_path = f'/home/sowjanya/Project/ISL/ISL_Gifs/{a}.gif'
            ...
            for char in a:
                if char in arr:
                    img_path = f'/home/sowjanya/Project/ISL/letters/{char}.jpg'
    ...
    with sr.Microphone() as source:
        ...
        try:
            ...
            if command in isl_gif:
                gif_path = f'/home/sowjanya/Project/ISL/ISL_Gifs/{command}.gif'
                if os.path.exists(gif_path):
                    st.image(gif_path)
                else:
                    st.write("GIF not found!")
...
if option == "Home":
    ...
    st.image("/home/sowjanya/Project/ISL/isl.jpg", use_column_width=True)
